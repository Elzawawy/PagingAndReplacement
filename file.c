...
void intializeList(LinkedList *list)
{
    list->head = list->tail = clockPointer = 
# 15 "LinkedList.c" 3 4
                                            ((void *)0)
# 15 "LinkedList.c"
                                                ;
